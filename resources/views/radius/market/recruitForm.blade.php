...
@section('content')
            ...
            <div class="row g-6">
                ...
                <div class="col-md-4" hidden>
                  ...
                  <input type="text" id="add-user-area" class="form-control" placeholder="Rumumaosi"
                      aria-label="Rumumaosi" name="sourced_area" required readonly/>
              </div>
                ...
                <div class="col-md-4">
                  <label for="created_by" class="form-label">Brought by</label>
                  <select id="created_by" class="form-select selectpicker w-100" name="created_by"
                      ...
                      @foreach ($staffs as $staff)
                          <option data-tokens="{{ $staff->id }}" value="{{ $staff->id }}">{{ $staff->name }}</option>
                      @endforeach
                  </select>
              </div>
              <div class="col-md-4">
    ...
    <div class="modal" id="stoutedAreaModal" tabindex="-1" role="dialog" aria-labelledby="stoutedAreaModalLabel" aria-hidden="true">
