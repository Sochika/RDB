                ...
                <div class="d-flex align-items-end row">
                    <div class="col-7">
                        <div class="card-body text-nowrap">
                            <h5 class="card-title mb-0">Welcome Radius! 🎉</h5>
                            <p></p>
            ...
            <h4 class="text-primary mb-1">$48.9k</h4> --}}
                    ...
                    <div class="col-5 text-center text-sm-left">
                        <div class="card-body pb-0 px-0 px-md-4">
                            <img src="{{ asset('assets/img/illustrations/radius_boy.png') }}" height="140"
                                alt="view sales">
                        </div>
                    </div>
                </div>
        ...
        <div class="col-xl-8 col-md-12">
            <div class="card h-100">
                <div class="card-header d-flex justify-content-between">
                    ...
                    {{-- <small class="text-muted">Updated 1 mintue ago</small> --}}
                </div>
                        ...
                        <div class="row gy-3">
                            <div class="col-md-3 col-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="card-info">
                                        <h5 class="mb-0">{{ $beats->count() ?? 0 }}</h5>
                                        <small>Beats</small>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 col-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="card-info">
                                        <h5 class="mb-0">{{ $staffs->count() ?? 0 }}</h5>
                                        <small>Operatives</small>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 col-6">
  ...
  <div class="col-xxl-4 col-12">
    <div class="row g-6">
      ...
      <div class="col-xl-12 col-sm-12">
        <div class="card">
          <h5 class="card-header">Gender Operatives</h5>
          <div class="card-body">
            <canvas id="doughnutChart" class="chartjs mb-6" data-height="200"></canvas>
            <ul class="doughnut-legend d-flex justify-content-around ps-0 mb-2 pt-1">

              <li class="ct-series-1 d-flex flex-column">
                <h5 class="mb-0">Female</h5>
                <span class="badge badge-dot my-2 cursor-pointer rounded-pill" style="background-color: rgb(207, 10, 233);width:35px; height:6px;"></span>
                <div class="text-muted">10 %</div>
              </li>
              <li class="ct-series-2 d-flex flex-column">
                <h5 class="mb-0">Males</h5>
                <span class="badge badge-dot my-2 cursor-pointer rounded-pill" style="background-color: rgb(13, 211, 218);width:35px; height:6px;"></span>
                <div class="text-muted">10 %</div>
              </li>
            </ul>
          </div>
                        ...
                        <ul class="doughnut-legend d-flex justify-content-around ps-0 mb-2 pt-1">
                            ...
                            <li class="ct-series-1 d-flex flex-column">
                                ...
                                <span class="badge badge-dot my-2 cursor-pointer rounded-pill"
                                    style="background-color: rgb(241, 33, 155);width:35px; height:6px;"></span>
                                <div class="text-muted">
                                    {{ $staffs ? round((($staffs->count() - $maleStaffs->count()) * 100) / $staffs->count()) : 0 }}
                                    %</div>
                            </li>
                            <li class="ct-series-0 d-flex flex-column">
                                <h5 class="mb-0">Males</h5>
                                <span class="badge badge-dot my-2 cursor-pointer rounded-pill"
                                    style="background-color: rgb(30, 150, 230);width:35px; height:6px;"></span>
                                <div class="text-muted">
                                    {{ $staffs ? round(($maleStaffs->count() * 100) / $staffs->count()) : 0 }} %</div>
                            </li>
