    ...
    @endphp --}}
        ...
        <div class="card">
            <div class="text-center mb-6">
                <h4 class="address-title mb-2">Beat Lead</h4>
                <p class="address-subtitle">Add Details</p>
            </div>
            <form id="addNewAddressForm" class="row g-6" action="{{ route('lead.store') }}" method="POST">
                @csrf
                        ...
                        <div class="col-md mb-md-0 mb-4">
                            <div class="form-check custom-option custom-option-icon">
                                <label class="form-check-label custom-option-content" for="customRadioHome">
                                    ...
                                    <input name="type" class="form-check-input" type="radio" value="resident"
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input type="text" id="companyName" name="companyName" class="form-control"
                        placeholder="St. Odumo" />
                </div>
                <div class="col-12 col-md-6">
                    <label class="form-label" for="modalAddressFirstName">Contact Name</label>
                    <input type="text" id="modalAddressFirstName" name="contact_name" class="form-control" required
                        placeholder="John Doe" />
                </div>
                <div class="col-12 col-md-6">
                    <label class="form-label" for="phone_number">Contact Phone Number</label>
                    <input type="text" id="phone_number" name="phone_number" class="form-control" required
                        placeholder="08095000000" />
                </div>
                <div class="col-12 col-md-6">
                ...
                <div class="col-12 ">
                    ...
                    <input type="text" id="modalAddressAddress" name="address" class="form-control"
                        placeholder="12, Flemimg Avenue" />
                </div>

                <div class="col-12 col-md-6">
                    <label class="form-label" for="modalAddressArea">Area</label>
                    <input type="text" id="modalAddressArea" name="area" class="form-control"
                        placeholder="Rumumaosi" required />
                </div>
                <div class="col-12 col-md-6">
                    <label class="form-label" for="modalAddressLandmark">Landmark</label>
                    <input type="text" id="modalAddressLandmark" name="landmark" class="form-control"
                        placeholder="Nr. First Bank" />
                </div>
                <div class="col-12 col-md-6">
                ...
                <div class="col-12 col-md-6">
                    <label class="form-label" for="modalNumOperative">Number of Propose Operative</label>
                    <input type="number" id="modalNumOperative" name="num_operative" class="form-control"
                        placeholder="5" />
                </div>
              ...
              <div class="col-12 col-md-6">
                ...
                <div class="col-12">
                    ...
                    <textarea class="form-control" name="note" id="modalNote" cols="20" rows="5"></textarea>
                </div>
