...
@section('content')
                    ...
                    <div class="d-flex align-items-start justify-content-between">
                        <div class="content-left">
                            ...
                            <div class="d-flex align-items-center my-1">
                                <h4 class="mb-0 me-2">{{ $myleads->count() }}</h4>
                                <p class="text-primary mb-0">({{$leads->count()}})</p>
                            </div>

                        </div>
                        <a href="{{route('admin.alleads')}}"><div class="avatar">
                    ...
                    <div class="d-flex align-items-start justify-content-between">
                        <div class="content-left">
                            ...
                            <div class="d-flex align-items-center my-1">
                                ...
                                <p class="text-success mb-0">({{$myleadOnboarded->count() }})</p>
                            </div>
                    ...
                    <div class="d-flex align-items-start justify-content-between">
                        <div class="content-left">
                            ...
                            <div class="d-flex align-items-center my-1">
                                ...
                                <p class="text-danger mb-0">({{$myleadsFailed}})</p>
                            </div>
                            {{-- <small class="mb-0">Last week analytics </small> --}}
                        </div>
                        <a href="{{route('admin.alleads')}}"><div class="avatar">
                    ...
                    <div class="d-flex align-items-start justify-content-between">
                        <div class="content-left">
                            ...
                            <div class="d-flex align-items-center my-1">
                                ...
                                <p class="text-danger mb-0">({{ $myleadTerminated }})</p>
                            </div>
                            {{-- <small class="mb-0">Last week analytics</small> --}}
                        </div>
                        <a href="{{route('admin.alleads')}}"><div class="avatar">
    ...
    <div class=" col-sm-3 col-xl-3">
        <a href="{{ route('adminLead.form') }}"><button type="button" class="btn btn-success">
