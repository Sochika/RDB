...
<div class="modal fade" id="addNewBeat" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-simple modal-add-new-address">
    <div class="modal-content">
      <div class="modal-body">
        ...
        <form id="addNewAddressForm" class="row g-6" onsubmit="return false" action="{{ route('beat.store') }}" method="POST">
          @csrf
              ...
              <div class="col-md mb-md-0 mb-4">
                <div class="form-check custom-option custom-option-icon">
                  <label class="form-check-label custom-option-content" for="customRadioHome">
                    ...
                    <input name="customRadioIcon" class="form-check-input" type="radio" value="resident" id="customRadioHome" checked />
                  </label>
                </div>
              </div>
              <div class="col-md mb-md-0 mb-4">
          ...
          <div class="col-12 col-md-6">
            ...
            <input type="text" id="modalAddressFirstName" name="first_name" class="form-control" placeholder="John" />
          </div>
          <div class="col-12 col-md-6">
            <label class="form-label" for="modalAddressLastName">Contact Last Name</label>
            <input type="text" id="modalAddressLastName" name="last_name" class="form-control" placeholder="Doe" />
          </div>

          <div class="col-12 col-md-6">
            <label class="form-label" for="phone_number">Contact Phone Number</label>
            <input type="text" id="phone_number" name="phone_number" class="form-control" placeholder="08095000000" />
          </div>
          <div class="col-12 col-md-6">
          ...
          <div class="col-12 ">
            ...
            <input type="text" id="modalAddressAddress1" name="Address1" class="form-control" placeholder="12, Business Park" />
          </div>
          <div class="col-12">
          ...
          <div class="col-12 col-md-6">
            ...
            <input type="text" id="modalAddressArea" name="area" class="form-control" placeholder="Rumumaosi" />
          </div>
          <div class="col-12 col-md-6">
            <label class="form-label" for="modalAddressLandmark">Landmark</label>
            <input type="text" id="modalAddressLandmark" name="modalAddressLandmark" class="form-control" placeholder="Nr. First Bank" />
          </div>
          <div class="col-12 col-md-6">
