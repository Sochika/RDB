...
class MarketController extends Controller
{
  ...
  public function index()
  {
    ...
    $level = 2;
    return view('radius.market.index', compact('leads', 'leadOnboarded', 'states', 'leadTerminated', 'leadsFailed', 'weekLeads', 'level'));
  }
  ...
  public function leads()
  {
    ...
    $level = 2;
    return view('radius.market.lead', compact('leads', 'myleads', 'leadOnboarded', 'myleadOnboarded', 'states', 'leadTerminated', 'myleadTerminated',  'leadsFailed', 'myleadsFailed', 'weekLeads', 'level'));
  }
  ...
  public function alleads()
  {
    ...
    $level = 2;
    return view('radius.market.leads', compact('leads', 'myleads', 'leadOnboarded', 'myleadOnboarded', 'states', 'leadTerminated', 'myleadTerminated',  'leadsFailed', 'myleadsFailed', 'level'));
  }
  ...
  public function allRecruits()
  {
    ...
    $level = 2;
    return view('radius.market.recruits', compact('recruits', 'myrecruits', 'recruitOnboarded', 'myrecruitOnboarded', 'states', 'recruitTerminated', 'myrecruitTerminated',  'recruitsFailed', 'myrecruitsFailed', 'level'));
  }
  ...
  public function recruits()
  {
    ...
    $level = 2;
    return view('radius.market.recruit', compact('recruits', 'recruitsApproved', 'states', 'recruitsGraduated', 'recruitsFailed', 'weekRecruits', 'level'));
  }
  ...
  public function recruitForm()
  {
    ...
    $staffs = User::all();
    $states = States::get();
    return view('radius.market.recruitForm', compact('states', 'staffs'));
  }
  ...
  public function beatForm()
  {
    $states = States::get();
    $staffs = User::all();
    return view('radius.market.leadForm', compact('states', 'staffs'));
  }
